package com.charagol.shortlink.project.common.constant;

public class RedisKeyConstant {

    /** NOTE
     *   将常用的RedisKey定义在这里，实现一次定义，多处使用；一次更改，多处同步
     *   RedisKey 之间命名规范：常使用冒号作为分隔符，在Redis中指定就能实现目录层级
     */
